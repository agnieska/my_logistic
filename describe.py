...
def create_describe_dictionnary(df_train, column_names_list):
    ...
    for c_name in column_names_list:
        ...
        descr_dict[column_name] = append_measures(ct, mean, std, q25, q50, q75, mi, ma)
    return descr_dict
...
def print_describe_results(data, column_names, measure_names, describe_dict):
    ...
    print("\n")
    desc = data[column_names[:5]].describe()
    print("PANDAS\n", desc)
    print_5_columns(column_names, measure_names, describe_dict, 5, 10)
    print("\n")
    desc = data[column_names[5:10]].describe()
    print("PANDAS\n", desc)
    print_5_columns(column_names, measure_names, describe_dict, 10, None)
    desc = data[column_names[10:]].describe()
    print("PANDAS\n", desc)
    # print_5_columns (column_names, measure_names, describe_dict, 2, 8)
...
def main():
    ...
    # Je compare les dimensions dans train et test
    print("*** TRAIN DATASET *** ")
    ...
    test_column_names = list(data_test.columns)
    print("Test columns : ", len(test_column_names))

    # Je choisis les colonnes pour calculer les statistiques descriptives
